export default class WilokeGoogleMap{
	constructor(mapID){
		this.mapID = mapID;
		this.init();
	}
	...
	setParams(){
		...
		let oConfiguration = this.$map.dataset;
		this.aConfiguration = Object.assign({}, oDefault, oConfiguration);
	}

	createMapMaker(oLatLng, icon){
		let oConfiguration = {
			position: oLatLng
		};
	...
	buildSingleMap(){
		...
		let oLatLng = this.parseLatLng(this.aConfiguration.latlng);
		this.aConfiguration.center = new google.maps.LatLng(oLatLng.lat, oLatLng.lng);

		let oInitMap = new google.maps.Map(this.$map, this.aConfiguration);
		let oMapMaker = this.createMapMaker(oLatLng, this.aConfiguration.icon);
		oMapMaker.setMap(oInitMap);

		// let oPanorama = new google.maps.StreetViewPanorama(
